...
# Automatic Gemini detection: if the key starts with AIzaSy and no base_url is set,
# we default to the Google Gemini OpenAI-compatible endpoint.
_effective_base_url = AI_INTEGRATIONS_OPENAI_BASE_URL
if AI_INTEGRATIONS_OPENAI_API_KEY and AI_INTEGRATIONS_OPENAI_API_KEY.startswith("AIzaSy") and not _effective_base_url:
    _effective_base_url = "https://generativelanguage.googleapis.com/v1beta/openai/"
