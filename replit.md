...
## Audits
- `docs/audits/world-class-audit.md` (Task #270) — 8-section initial pass with backlog (B-1 .. B-8). Items shipped this session: `frontend/public/manifest.webmanifest`, locale-layout `viewport` block (incl. `themeColor` light/dark), Settings language test, MSW handlers, i18n test helper, and the post-i18n Locust baseline at `tests/performance/baselines/post-i18n.md`.
