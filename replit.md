...
- **AI-Powered Chat**: A project-aware AI assistant leveraging OpenAI GPT, supporting multi-conversation sessions, and enriching system prompts with project datasets, relationships, and learned notes for transparent and context-rich responses.
